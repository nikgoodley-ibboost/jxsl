...
public class XspecTestScenarioRunner implements XslTestScenarioRunner
{
    ...
    {
        return run(xspecFile, outputDir);
    }

    /**
     * 
     * Return in runReport: mainOutput = XML file test results first
     * otherOutputFiles = HTML file test report
     * 
     */
    @Override
    public RunReport run(File xspecFile, File outputDir)
    {
